...
#CV_DESCRIPTION = "Calculates the distance to the closest zero pixel for each pixel in the image." + Chr(10) + Chr(10) +
                  "- SPACEBAR: Add/Remove normalize." + Chr(10) + Chr(10) +
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200 And *resize\nChannels = 3
      *gray.IplImage = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_8U, 1)
      ...
      cvThreshold(*gray, *gray, 150, 150, #CV_THRESH_BINARY)
      *distance.IplImage = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_32F, 1)
      cvDistTransform(*gray, *distance, #CV_DIST_L2, #CV_DIST_MASK_PRECISE, #Null, #Null, #CV_DIST_LABEL_CCOMP)    
      *convert.IplImage = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_8U, 1)
      ...
      *param\uValue = window_handle
      ...
      Repeat
        If *color
          cvConvertScale(*distance, *convert, 255, 0)
          cvCvtColor(*convert, *color, #CV_GRAY2BGR, 1)
          ...
          *reset = cvCloneImage(*color)
          ...
          Select keyPressed
            Case 32
              ...
              If normalize : cvNormalize(*distance, *distance, 0, 1, #NORM_MINMAX, #Null) : EndIf

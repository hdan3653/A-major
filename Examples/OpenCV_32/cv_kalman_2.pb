...
#CV_DESCRIPTION = "Tracks a rotating point at a constant rotation speed where both state and measurement " +
                  "vectors are a 1D point angle; measurement being the real point angle + gaussian noise." +
                  Chr(10) + Chr(10) + "The real and estimated points are connected by a yellow line segment." +
                  Chr(10) + Chr(10) + "The real and the measured points are connected by a red line segment." +
                  Chr(10) + Chr(10) + "- SPACEBAR: Reset the rotating tracking point to a different speed." +

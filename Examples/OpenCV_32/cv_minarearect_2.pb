...
#CV_DESCRIPTION = "Calculates the contour areas." + Chr(10) + Chr(10) + "For each point set:" + Chr(10) +
                  "- degree of tilt / center of mass" + Chr(10) + "- bounding rectangle / minimal area"
      ...
      *contour.IplImage = cvCreateImage(*gray\width, *gray\height, #IPL_DEPTH_8U, 3)
      ...
      For rtnCount = 0 To nContours - 1
        ...
        If area >= 35 And area <= 100000
          ...
          pt2(3)\x = pt1(3)\x
          pt2(3)\y = pt1(3)\y
          cvLine(*contour, pt2(0)\x, pt2(0)\y, pt2(1)\x, pt2(1)\y, 0, 255, 255, 0, 1, #CV_AA, #Null)
          cvLine(*contour, pt2(1)\x, pt2(1)\y, pt2(2)\x, pt2(2)\y, 0, 255, 255, 0, 1, #CV_AA, #Null)
          cvLine(*contour, pt2(2)\x, pt2(2)\y, pt2(3)\x, pt2(3)\y, 0, 255, 255, 0, 1, #CV_AA, #Null)
          cvLine(*contour, pt2(3)\x, pt2(3)\y, pt2(0)\x, pt2(0)\y, 0, 255, 255, 0, 1, #CV_AA, #Null)

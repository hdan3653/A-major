CompilerIf #PB_Compiler_Version >= 530
  ...
  #CV_DESCRIPTION = "Using OpenGL and textures, the webcam interface is displayed onto the front and inverted onto " +
                    "the back of a revolving rectangle."
  ...
  If *capture
    ...
    *window_name = cvGetWindowName(window_handle)
    ...
    If OpenWindow(0, 0, 0, FrameWidth, FrameHeight, #CV_WINDOW_NAME, #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
      ...
      *image.IplImage : Dim matrix.f(16)

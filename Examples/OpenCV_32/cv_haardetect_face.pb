...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, scaleFactor, minNeighbors

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Tries to detect frontal-faces of different sizes using HaarCascades." + Chr(10) + Chr(10) +
      ...
      *param\uValue = window_handle
      ...
      Repeat
        If *resize1
          ...
          *faces = cvHaarDetectObjects(*resize2, *cascade, *storage, 1 + ((scaleFactor + 1) / 10), minNeighbors, flags + 1, 0, 0, 0, 0)
              ...
              If face <> faceOld
                Select mask
                  Case 0
                    ...
                    EndSelect
                  Case 1 To 4
                  *resize1 = SetMask(*resize1, "images/mask" + Str(mask) + ".jpg", x, y, Abs(width - x), Abs(height - y))
                EndSelect
              EndIf
            EndIf
          Next

...
#CV_DESCRIPTION = "Calculates a feature map for corner detection." + Chr(10) + Chr(10) +
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200 And *resize\nChannels = 3
      ...
      *corner.IplImage = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_32F, 1)
      *dilate.IplImage = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_8U, 1)
      ...
      *kernel.IplConvKernel = cvCreateStructuringElementEx(3, 3, 1, 1, #CV_SHAPE_RECT, #Null)
      ...
      cvPreCornerDetect(*gray, *corner, 13)
      cvErode(*corner, *corner, *kernel, 1)
      cvDilate(*corner, *corner, *kernel, 5)
      cvConvertScale(*corner, *dilate, 255, 0)
      cvCvtColor(*dilate, *color, #CV_GRAY2BGR, 1)

...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, nPencil

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Simulate a color / black && white pencil sketch from an image." + Chr(10) + Chr(10) +
                  "- SPACEBAR: Start / Swap sketch." + Chr(10) + Chr(10) +
...
ProcedureC PencilFilter(*horiz.CvMat, *pencil.CvMat, radius.f)
  myinf.d = 9.9e307
  h = *horiz\rows
  w = *horiz\cols
...
ProcedureC PencilSketch(*image.IplImage, sigma_s.f, sigma_r.f, shade.f, *ps.PENCIL_SKETCH)
  iterations = 1
  w = *image\width
  h = *image\height
	channel = *image\nChannels

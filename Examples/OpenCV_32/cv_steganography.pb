...
#CV_DESCRIPTION = "Steganography is the practice of concealing a file, message, image, or video within another file, message, image, or video." +
                  Chr(10) + Chr(10) + "- SPACEBAR: Extract text to notepad."
...
ProcedureC ExtractText(ImageFile.s, *steganography.IplImage, nWidth, nHeight)

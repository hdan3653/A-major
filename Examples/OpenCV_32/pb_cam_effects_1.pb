...
#CV_DESCRIPTION = "Setting 1: Applies a fixed-level threshold to each array element." + Chr(10) + Chr(10) +
...
If *capture
  ...
  *window_name = cvGetWindowName(window_handle)
  ...
  If OpenWindow(0, 0, 0, FrameWidth, FrameHeight + 60, #CV_WINDOW_NAME, #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    ...
    ButtonGadget(0, 10, 490, 620, 40, "Toggle the webcam view between the Threshold effect with and without the Canny86 algorithm", #PB_Button_Toggle)

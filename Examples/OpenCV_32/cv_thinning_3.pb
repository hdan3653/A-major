...
#CV_DESCRIPTION = "A five stage two-dimensional filter applied to a grayscale image " +
                  "producing a skeleton effect. ~Developed by: T. Kasvand." +
                  Chr(10) + Chr(10) + "- SPACEBAR: Show the next stage." +

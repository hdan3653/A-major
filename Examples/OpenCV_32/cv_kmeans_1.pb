...
#CV_DESCRIPTION = "Image segmentation by k-means clustering and color reduction." + Chr(10) + Chr(10) +
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200 And *resize\nChannels = 3
      ...
      *centers.CvMat = cvCreateMat(#MAX_CLUSTERS, 3, CV_MAKETYPE(#CV_32F, 1))
      cvKMeans2(*points, #MAX_CLUSTERS, *clusters, #CV_TERMCRIT_ITER | #CV_TERMCRIT_EPS, 10, 1.0, 1, 0, 0, *centers, 0)

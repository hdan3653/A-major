...
#CV_DESCRIPTION = "Using a Poisson blending algorithm, two similarly colored images are blended together." +
...
ProcedureC OpenCV(ImageFile.s, nBlend)
  If FileSize(ImageFile) > 0
    ...
    *roi.IplImage = cvLoadImage("images/blend1_" + Str(nBlend + 1) + "b.png", #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
      ...
      *param\uValue = window_handle
      ...
      Select nBlend
        Case 0
          ...
          y = (*resize\height / 2) - (*roi\height / 2) + 50
        Case 1
          x = 10
          y = 350
        Case 2
          x = *resize\width - *roi\width
          y = *resize\height - *roi\height
        Case 3
          x = *resize\width - *roi\width
          y = 0
        Case 4
    ...
    If keyPressed = 13
      exitCV = #False
      nBlend = (nBlend + 1) % 5
      OpenCV("images/blend1_" + Str(nBlend + 1) + "a.png", nBlend)
    EndIf
  EndIf
EndProcedure

ExamineDesktops()
OpenCV("images/blend1_1a.png", 0)

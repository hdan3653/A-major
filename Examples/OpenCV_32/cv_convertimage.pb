...
#CV_DESCRIPTION = "Converts from one image to another with optional vertical flip." + Chr(10) + Chr(10) +
                  "- SPACEBAR: Vertical flip." + Chr(10) + Chr(10) +
                  "- [ S ] KEY: Swap RB colors."
...
ProcedureC OpenCV(ImageFile.s)
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    cvConvertImage(*resize, *resize, #CV_CVTIMG_SWAP_RB)
    ...
    *param\uValue = window_handle
    ...
    Repeat
      If *resize
        ...
        Select keyPressed
          Case 32
            cvConvertImage(*resize, *resize, #CV_CVTIMG_FLIP)
          Case 83, 115
            cvConvertImage(*resize, *resize, #CV_CVTIMG_SWAP_RB)
        EndSelect
      EndIf

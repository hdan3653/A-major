...
Global *save.IplImage, exitCV.b, lpPrevWndFunc, *fractal.IplImage, iCount, nFont.CvFont

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Generates an iterative Mandelbrot Set, the most popular geometrical fractal." + Chr(10) + Chr(10) +
                  "- MOUSE: Select an area to enlarge." + Chr(10) + Chr(10) +
                  "- SPACEBAR: Flip RGB / BGR." + Chr(10) + Chr(10) +
                  "- ENTER: Reset the fractal." + Chr(10) + Chr(10) +
                  "- [ P ] KEY: Show previous selection."

...
#CV_DESCRIPTION = "Sparse optical flow technique using the Lucas-Kanade algorithm." + Chr(10) + Chr(10) +
                  "- MOUSE: Add/Remove tracking dots." + Chr(10) + Chr(10) +
                  "- SPACEBAR: Default tracking dots." + Chr(10) + Chr(10) +
                  "- ENTER: Clear all tracking dots." + Chr(10) + Chr(10) +
                  "- [ N ] KEY: Enter/Exit Night-Mode." + Chr(10) + Chr(10) +

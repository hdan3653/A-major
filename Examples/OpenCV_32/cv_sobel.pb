...
#CV_DESCRIPTION = "Calculates the first, second, third, or mixed image derivatives using an extended Sobel operator." +
                  Chr(10) + Chr(10) + "- SPACEBAR: Vertical / Horizontal." +
          ...
          Select keyPressed
            Case 32
              ...
              *resize = cvCloneImage(*reset)
              ...
              If sobel : cvSobel(*resize, *resize, 1, 0, 3) : Else : cvSobel(*resize, *resize, 0, 1, 3) : EndIf

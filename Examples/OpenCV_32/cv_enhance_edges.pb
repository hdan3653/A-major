...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, nEdge

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Enhance the edges of an image in 2 stages using various filters." + Chr(10) + Chr(10) +
                  "- SPACEBAR: Start next stage." + Chr(10) + Chr(10) +
...
ProcedureC GetGradientX(*image.CvMat, *gx.CvMat)
  h = *image\rows
  w = *image\cols
  cvSetZero(*gx)
...
ProcedureC GetGradientY(*image.CvMat, *gy.CvMat)
  h = *image\rows
  w = *image\cols
  cvSetZero(*gy)
...
ProcedureC FindMagnitude(*image.CvMat)
  h = *image\rows
  w = *image\cols
  Dim *planes.CvMat(3)
...
ProcedureC NormalizedFilter(*edge.CvMat, *horiz.CvMat, radius.f)
  myinf.d = 9.9e307
  h = *edge\rows
  w = *edge\cols

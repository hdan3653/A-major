...
#CV_DESCRIPTION = "Haar-Training in stages for single face recognition (old version)." + Chr(10) + Chr(10) +
...
ProcedureC CvMouseCallback(event, x.l, y.l, flags, *param.USER_INFO)
  Select event
    ...
    Case #CV_EVENT_LBUTTONDBLCLK
      RunProgram("http://www.computer-vision-software.com/blog/2009/11/faq-opencv-haartraining/comment-page-1/")
  EndSelect
EndProcedure
        ...
        Case 84, 116
          If posCount > 0 And FileSize("trained/positives.vec") > 0
            If negCount > 0
              ...
              RunProgram("opencv_haartraining.exe", "-data haarcascade_frontalface_JHPJHP -vec trained\positives.vec -bg trained\neg_train.txt -npos " + Str(posCount * 0.9) + " -nneg " + Str(negCount) + " -nstages " + Str(nStages) + " -nsplits 2 -mem 512 -nonsym -minhitrate 0.999 -w " + Str(whHaar) + " -h " + Str(whHaar), "")
              Break
            Else

...
#CV_DESCRIPTION = "Generates the top view of a chessboard pattern from its perspective view." + Chr(10) + Chr(10) +
                  "- SPACEBAR: Switch to top view." + Chr(10) + Chr(10) +
                  "- [ < / > ] KEYS: Adjust Z-height." + Chr(10) +
                  "(applies only in top view mode)"

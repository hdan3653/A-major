...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, nArea

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Calculates the contour areas." + Chr(10) + Chr(10) + "- TRACKBAR: Adjust contour area."
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200
      nArea = 100
      cvCreateTrackbar("Area", #CV_WINDOW_NAME, @nArea, 3000, @CvTrackbarCallback())
      ...
      *contours.CvSeq
      ...
      If nContours
        ...
        *param\uValue = window_handle
        ...
        Repeat
          If *contour
            cvSet(*contour, 0, 0, 0, 0, #Null)

            For rtnCount = 0 To nContours - 1
              area.d = cvContourArea(*contours, 0, #CV_WHOLE_SEQ_END_INDEX, 0)

              If area >= nArea : cvDrawContours(*contour, *contours, 255, 155, 0, 0, 155, 255, 0, 0, 0, 1, #CV_AA, 0, 0) : EndIf

...
Global lpPrevWndFunc, *imgTracking.IplImage,*imgTracking2.IplImage , lastX, lastY, last2X, last2Y , nCursor
...
ProcedureC GetThresholdedImage(*imgHSV.IplImage)
  *imgThresh.IplImage = cvCreateImage(*imgHSV\width, *imgHSV\height, #IPL_DEPTH_8U, 1)
  cvInRangeS(*imgHSV, 160, 140, 40, 0, 179, 255, 255, 0, *imgThresh) ; red
...
ProcedureC GetThresholdedImage2(*imgHSV.IplImage)
  *imgThresh2.IplImage = cvCreateImage(*imgHSV\width, *imgHSV\height, #IPL_DEPTH_8U, 1)
  cvInRangeS(*imgHSV, 65 , 60, 60, 0, 80, 255, 255, 0, *imgThresh2) ; green
...
ProcedureC TrackObject2(*imgThresh2.IplImage)
  moments.CvMoments
  ...
  If area > 1000
    ...
    If last2X >= 0 And last2Y >= 0 And posX >= 0 And posY >= 0
      cvLine(*imgTracking2, posX, posY, last2X, last2Y, 0, 255, 0, 0, 4, #CV_AA, #Null)
    ...
    *image = cvQueryFrame(*capture)
    ...
    If *image
      ...
      *imgThresh2.IplImage = GetThresholdedImage2(*imgHSV)
      ...
      ;##################################;
      cvLine(*image, lastX, lastY, last2X, last2Y, 0, 255, 255, 0, 4, #CV_AA, #Null)
      ...
      Repeat
        ...
        Else
          ...
          bottom = ptBottom
        EndIf
        cvRectangle(*image, left, top, right, bottom, 0, 0, 255, 0, 2, #CV_AA, #Null)
        count+1
      Until count >= 7

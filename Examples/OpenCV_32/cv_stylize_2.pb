...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, nStyle
...
ProcedureC RecursiveFilter(*style.CvMat, *horiz.CvMat, sigma_h.f)
  h = *style\rows
  w = *style\cols
...
ProcedureC SmoothEdge(*image.IplImage, sigma_s.f, sigma_r.f)
  ...
  *style_t.CvMat = cvCreateMat(w, h, CV_MAKETYPE(#CV_32F, 3))
  ...
  RecursiveFilter(*style, *horiz, sigma_h)
  cvTranspose(*style, *style_t)
  RecursiveFilter(*style_t, *vert_t, sigma_h)

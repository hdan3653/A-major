...
#CV_DESCRIPTION = "Calculates the contour areas, approximating polygonal curves with specified precision." + Chr(10) + Chr(10) +
                  "For each point set:" + Chr(10) +
                  "- small circle at center of mass" + Chr(10) + "- current precision setting" + Chr(10) +
                  "- number of polygonal curves" + Chr(10) + "- bounding rectangle"
      ...
      *element.CvPoint
      ...
      For rtnCount = 0 To nContours - 1
        ...
        If area >= 35 And area <= 100000
          ...
          *poly = cvApproxPoly(*contours, SizeOf(CvContour), *storage, #CV_POLY_APPROX_DP, 0, 1)
          ...
          cvPolyLine(*contour, pts(), @npts, 1, #True, 0, 255, 255, 0, 1, #CV_AA, #Null)

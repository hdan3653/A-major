...
#CV_DESCRIPTION = "Detect skin tones using the RGB (Red, Green and Blue) color space." + Chr(10) + Chr(10) +
    ...
    If *image
      ...
      For y = 0 To FrameHeight - 1
        For x = 0 To FrameWidth - 1
          ...
          If (nR > 95 And nG > 40 And nB > 20 And nR - nB > 15 And nR - nG > 15) Or (nR > 200 And nG > 210 And nB > 170 And Abs(nR - nB) <= 15 And nR > nB And nG > nB)

...
#CV_DESCRIPTION = "A fine-grained saliency algorithm is applied to an image: The distinct subjective " +
                  "perceptual quality which makes some objects stand out from their neighbors." +
...
ProcedureC ImageCopy(*srcArg.IplImage, *dstArg.IplImage)
  If *dstArg\nChannels = 1
...
ProcedureC.f GetMean(*srcArg.IplImage, x, y, neighbourhood, centerVal)
...
ProcedureC GetIntensityScaled(*integralImage.IplImage, *gray.IplImage, *intensityScaledOn.IplImage, *intensityScaledOff.IplImage, neighborhood)
...
ProcedureC MixScales(Array *intensityScaledOn.IplImage(1), *intensityOn.IplImage, Array *intensityScaledOff.IplImage(1), *intensityOff.IplImage, numScales)
...
ProcedureC MixOnOff(*intensityOn.IplImage, *intensityOff.IplImage, *intensityArg.IplImage)
...
ProcedureC CalcIntensityChannel(*srcArg.IplImage, *dstArg.IplImage)
  numScales = 6
  Dim neighborhoods(6)
  neighborhoods(0) = 3 * 4

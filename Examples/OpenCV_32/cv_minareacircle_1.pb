...
#CV_DESCRIPTION = "Creates a sequence of points, bounding them in a circle of the minimal area."
...
*image.IplImage = cvCreateImage(600, 560, #IPL_DEPTH_8U, 3)
...
Next
center.CvPoint2D32f
cvMinEnclosingCircle(*sequence, @center, @radius.f)
cvCircle(*image, center\x, center\y, radius, 0, 255, 255, 0, 1, #CV_AA, #Null)
font.CvFont : cvInitFont(@font, #CV_FONT_HERSHEY_SIMPLEX, 0.5, 0.5, #Null, 1, #CV_AA)
cvPutText(*image, Str(*sequence\total) + " Points", 20, 520, @font, 255, 200, 100, 0)

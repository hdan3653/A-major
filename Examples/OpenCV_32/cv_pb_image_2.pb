...
#CV_DESCRIPTION = "Formats a PureBasic image to work with OpenCV."
...
ProcedureC OpenCV(ImageFile.s)
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvCreateImage(ImageWidth(pbimage), ImageHeight(pbimage), #IPL_DEPTH_8U, 3)
...
; IDE Options = PureBasic 5.30 Beta 2 (Windows - x86)
; CursorPosition = 1
; Folding = -
; EnableXP
; DisableDebugger

...
#CV_DESCRIPTION = "Performing the meanshift segmentation of an image, a cartoon effect is achieved." + Chr(10) + Chr(10) +
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200 And *resize\nChannels = 3
      ...
      *color.IplImage = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_8U, 3)
      ...
      cvSetImageROI(*resize, 0, 0, *resize\width, *resize\height)
      cvSetImageROI(*cartoon, 0, 0, *resize\width, *resize\height)
      cvPyrMeanShiftFiltering(*resize, *cartoon, 0, 0, 1, #CV_TERMCRIT_ITER | #CV_TERMCRIT_EPS, 5, 1)

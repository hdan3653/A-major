...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, Dim dstPoint.CvPoint2D32f(0), nColor, nR, nG, nB

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Apply a perspective transform calculated from four pairs of points to an image, overlayed onto another image." +
                  Chr(10) + Chr(10) + "- MOUSE: Add 4 x/y points." +
                  Chr(10) + Chr(10) + "- SPACEBAR: Execute overlay." +
                  Chr(10) + Chr(10) + "- ENTER: Reset the image." +
                  Chr(10) + Chr(10) + "- [ C ] KEY: Select color for overlay."
  ...
  Select event
    ...
    Case #CV_EVENT_LBUTTONDOWN
      If ArraySize(dstPoint()) < 4
        ...
        cvCircle(*param\uPointer2, x, y, 3, 255, 0, 0, 0, #CV_FILLED, #CV_AA, #Null)
        cvShowImage(#CV_WINDOW_NAME, *param\uPointer2)
      EndIf
  EndSelect
EndProcedure
...
ProcedureC OpenCV(ImageFile.s)
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage("images/transform1.png", #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    *logo.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *logo\nChannels = 3
      ...
      EndIf
      *transform.IplImage = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_8U, 3)
      ...
      *param\uValue = window_handle
      ...
      If keyPressed = 32
        ...
        Repeat
          If *resize
            If keyPressed = 32 And ArraySize(dstPoint()) = 4
      ...
      ElseIf keyPressed = 67 Or keyPressed = 99
        nColor = 1
      EndIf
      FreeMemory(*param)

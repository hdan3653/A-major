...
#CV_DESCRIPTION = "Calculates the weighted sum of the input image and the accumulator creating a silhouette " +
                  "effect, detecting objects found within one or more zones." +
                  Chr(10) + Chr(10) + "- SPACEBAR: Toggle views." +
                  Chr(10) + Chr(10) + "- MOUSE: Toggle zones." +
                  Chr(10) + Chr(10) + "- [ < / > ] KEYS: Add/Remove rows && columns hold SHIFT key for columns." +
                  Chr(10) + Chr(10) + "- [ A ] KEY: Toggle alarm." +
                  Chr(10) + Chr(10) + "- [ G ] KEY: Toggle grid." +
                  Chr(10) + Chr(10) + "- [ T ] KEY: Toggle tracking." +
                  Chr(10) + Chr(10) + "- [ V ] KEY: Change PIP view." +
                  Chr(10) + Chr(10) + "- [ Z ] KEY: Toggle all zones."
...
Procedure PlayWAVFile(*sound.SOUND_INFO)
  Repeat
    If *sound\PlayFile : sndPlaySound_(*sound\FileName + Chr(0), #SND_NODEFAULT + #SND_SYNC + #SND_FILENAME) : Else : Delay(100) : EndIf
    ...
    If *image
      ...
      Select keyPressed
        ...
        Case 90, 122
          ...
          If status : zone ! 1 : status = 0 : EndIf

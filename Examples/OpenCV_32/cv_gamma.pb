...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, nGamma.d, nImage

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Gamma Correction: The relationship between a pixels numerical value and its actual luminance." +
                  Chr(10) + Chr(10) + "- TRACKBAR: Adjust gamma value." +
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200
      cvCreateTrackbar("Gamma", #CV_WINDOW_NAME, 0, 20, @CvTrackbarCallback())
      *gamma.IplImage
      BringToTop(hWnd)
      ...
      Repeat
        If *resize
          If nGamma < 1
            ...
            *gamma = cvCloneImage(*resize)
          Else
            *gamma = GammaCorrection(*resize, nGamma)
          EndIf
          cvShowImage(#CV_WINDOW_NAME, *gamma)
          *param\uPointer1 = *gamma

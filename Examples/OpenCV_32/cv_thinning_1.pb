...
#CV_DESCRIPTION = "Repeated iterations using an edge detection algorithm on a grayscale " +
                  "image producing increasingly thinner edges. ~Developed by: T. Kasvand." +
                  Chr(10) + Chr(10) + "- SPACEBAR: Start thinning process." +

...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, hWnd_watershed, *watershed.IplImage

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Performs a marker-based image segmentation using the watershed algorithm." + Chr(10) + Chr(10) +
                  "- MOUSE: Mark objects on the image." + Chr(10) + Chr(10) +
                  "- SPACEBAR: Run the Watershed algorithm against the marked objects." + Chr(10) + Chr(10) +
                  "- ENTER: Restore the original image."

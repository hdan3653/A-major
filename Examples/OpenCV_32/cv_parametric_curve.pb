...
Global *save.IplImage, exitCV.b, lpPrevWndFunc, nParameter

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Parametric Curve: A curve defined as a function of independent variables." + Chr(10) + Chr(10) +
                  "- TRACKBAR: Adjust parameter." + Chr(10) + Chr(10) +
...
cvCreateTrackbar("Parameter", #CV_WINDOW_NAME, @nParameter, 20, @CvTrackbarCallback())

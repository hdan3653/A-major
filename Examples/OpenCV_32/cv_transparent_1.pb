...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, *resize.IplImage, hWnd_watershed, *watershed2.IplImage, *transparent.IplImage, outLine.b

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Using the watershed algorithm, an object can be extracted and saved to a transparent PNG file." +
                  Chr(10) + Chr(10) + "- MOUSE: Mark objects on the image." +
                  Chr(10) + Chr(10) + "- SPACEBAR: Run the Watershed algorithm against the marked objects." +
                  Chr(10) + Chr(10) + "- DOUBLE-CLICK: Extract objects." +
                  Chr(10) + Chr(10) + "- ENTER: Restore the original image."
      ...
      If Bool(flags And #CV_EVENT_FLAG_LBUTTON)
        ...
        If pt1\x > 0 And pt2\x < 60000 And pt2\y < 60000
          If outLine
            ...
            cvLine(*param\uPointer2, pt1\x, pt1\y, pt2\x, pt2\y, 255, 0, 0, 0, 4, #CV_AA, #Null)

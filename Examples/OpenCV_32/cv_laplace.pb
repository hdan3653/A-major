...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, nAperture

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Calculates the Laplacian of an image." + Chr(10) + Chr(10) +
                  "- TRACKBAR: Adjust aperture size." + Chr(10) + Chr(10) +
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200 And *resize\nChannels = 3
      cvCreateTrackbar("Aperture", #CV_WINDOW_NAME, @nAperture, 10, @CvTrackbarCallback())
      ...
      *param\uValue = window_handle
      ...
      Repeat
        If *resize
          cvLaplace(*reset, *resize, nAperture + 1)

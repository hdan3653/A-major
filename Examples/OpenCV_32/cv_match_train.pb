...
#CV_DESCRIPTION = "Creates a text file to later match contours against two image files containing numbers." + Chr(10) + Chr(10) +
                  "- ENTER: Skip current number." + Chr(10) + Chr(10) +
                  "- [ 0 - 9 ] KEYS: Match number."

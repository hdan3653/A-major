...
Global getCV.b, *save.IplImage, exitCV.b, lpPrevWndFunc, nDistortion.f, centerX.f, centerY.f

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Standard fisheye lens effect derived from mathematical equations." + Chr(10) + Chr(10) +
                  "- TRACKBAR: Adjust the distortion." + Chr(10) + Chr(10) +
                  "- MOUSE: Move X/Y distortion axis." + Chr(10) + Chr(10) +
                  "- ENTER: Reset distortion to center."
...
ProcedureC.f CalcShift(x1.f, x2.f, cx.f, dist.f)
  x3.f = x1 + (x2 - x1) * 0.5
...
ProcedureC.f GetRadialX(x.f, y.f, cx.f, cy.f, dist.f)
  x * xScale + xShift
  y * yScale + yShift
...
ProcedureC.f GetRadialY(x.f, y.f, cx.f, cy.f, dist.f)
  x * xScale + xShift
  y * yScale + yShift
...
ProcedureC GetScalar(*image.IplImage, idx0.f, idx1.f, *res.CvScalar)

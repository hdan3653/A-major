...
#CV_DESCRIPTION = "Gradients of motion history are used to detect direction of motion.  Using thresholded layer " +
                  "gradients of decaying frame differencing, new movements are stamped on top of each other by " +
                  "time code; motions too old are thresholded away."
...
ProcedureC UpdateMHI(*image.IplImage, *motion.IplImage, threshold)
  idx1 = last

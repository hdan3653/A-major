...
#CV_DESCRIPTION = "Distort a grayscale image by manipulating pixel locations." + Chr(10) + Chr(10) +
    ...
    Case #CV_EVENT_MOUSEMOVE
      If Bool(flags And #CV_EVENT_FLAG_LBUTTON)
        ...
        If pt1\x > 0 And pt2\x < 60000 And pt2\y < 60000
          cvLine(*param\uPointer1, pt1\x, pt1\y, pt2\x, pt2\y, 0, 0, 0, 0 , 4, #CV_AA, #Null)
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_GRAYSCALE)
    ...
    If *resize\width > 200 And *resize\height > 200
      ...
      *distort.CvMat = cvCreateMat(*resize\height, *resize\width, CV_MAKETYPE(#CV_8U, 1))

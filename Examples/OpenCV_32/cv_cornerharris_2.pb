  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200 And *resize\nChannels = 3
      ...
      *harris32.IplImage = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_32F, 1)
      *harris8.IplImage = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_8U, 1)
      ...
      *kernel.IplConvKernel = cvCreateStructuringElementEx(3, 3, 1, 1, #CV_SHAPE_RECT, #Null)
      ...
      cvSmooth(*gray, *gray, #CV_MEDIAN, 3, 3, 0, 0)
      cvThreshold(*gray, *gray, 0, 255, #CV_THRESH_BINARY | #CV_THRESH_OTSU)
      cvCornerHarris(*gray, *harris32, 4, 7, 0.07)
      cvErode(*harris32, *harris32, *kernel, 1)
      cvDilate(*harris32, *harris32, *kernel, 5)
      cvConvertScale(*harris32, *harris8, 255, 0)
      cvCvtColor(*harris8, *color, #CV_GRAY2BGR, 1)
      ...
      *param\uValue = window_handle
      ...
      cvReleaseImage(@*PIP)
      cvReleaseImage(@*color)
      cvReleaseImage(@*harris8)
      cvReleaseImage(@*harris32)
      cvReleaseImage(@*gray)

...
#CV_DESCRIPTION = "Shows OpenCV's available border styles on a loaded image." + Chr(10) + Chr(10) +
                  "- SPACEBAR: Switch between borders."
...
ProcedureC OpenCV(ImageFile.s)
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *image\width + offset >= dtWidth - 100 Or *image\height + offset >= dtHeight - 100
      iWidth = dtWidth - (100 + offset)
      iRatio1.d = iWidth / *image\width
      iHeight = dtHeight - (100 + offset)
          ...
          If keypressed = 32
            ...
            Select border
              ...
              Case #IPL_BORDER_REFLECT_101
                style = "REFLECT 101"
              Case #IPL_BORDER_TRANSPARENT
            EndSelect
          EndIf
          cvCopyMakeBorder(*resize, *border, (offset - 1) / 2, (offset - 1) / 2, border, B, G, R, 0)
          cvPutText(*border, style, 22, *border\height - 18, @font, 0, 0, 0, 0)
          cvPutText(*border, style, 20, *border\height - 20, @font, 255, 255, 255, 0)
          cvShowImage(#CV_WINDOW_NAME, *border)

...
#CV_DESCRIPTION = "Displays either a second webcam or simulates a second webcam by duplicating the main one, " +
                  "located in a small PIP window and enclosed within a border." + Chr(10) + Chr(10) +
...
Repeat
  nCreate + 1
  *capture2.CvCapture = cvCreateCameraCapture(#CV_CAP_ANY + 1)  

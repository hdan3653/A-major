...
#CV_DESCRIPTION = "Divides a multi-channel array into several single-channel arrays, then combines them excluding " +
                  "1 channel to create a new multi-channel array." + Chr(10) + Chr(10) +
                  "- SPACEBAR: Exclude next channel." + Chr(10) + Chr(10) +
      ...
      *param\uValue = window_handle
      ...
      Repeat
        If *dst
          ...
          EndSelect
          cvPutText(*dst, color, 22, *dst\height - 18, @font, 0, 0, 0, 0)
          cvPutText(*dst, color, 20, *dst\height - 20, @font, 255, 255, 255, 0)
              ...
              *dst = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_8U, *resize\nChannels)
              ...
              Select split
                ...
                Case 1
                  ...
                  color.s = "GREEN REMOVED"
                Case 2
                  cvMerge(#Null, *dst1, *dst2, #Null, *dst)
                  color.s = "BLUE REMOVED"
              EndSelect

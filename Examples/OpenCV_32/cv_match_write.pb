...
Global *save.IplImage, *reset.CvContour, exitCV.b, lpPrevWndFunc

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Tries to match contours learned from one image file containing numbers against another, " +
                  "then duplicate the number sequence using text." + Chr(10) + Chr(10) +
                  "Double-Click the window to open the associated image."

...
#CV_DESCRIPTION = "Demonstrates the ability to select an area on the webcam interface." +
                  Chr(10) + Chr(10) + "- MOUSE: Highlight/Select area." +
                  Chr(10) + Chr(10) + "- SPACEBAR: Switch background." +
                  Chr(10) + Chr(10) + "- ENTER: Reset the webcam."
...
If *capture
  ...
  *canny_1.IplImage = cvCreateImage(FrameWidth, FrameHeight, #IPL_DEPTH_8U, 1)
  *canny_3.IplImage = cvCreateImage(FrameWidth, FrameHeight, #IPL_DEPTH_8U, 3)
  ...
  *param\uValue = window_handle
    ...
    If *image
      ...
      Select select_object
        Case -1
          ...
          cvCanny(*gray, *canny_1, threshold * 0.5, threshold, 3, #False)
          cvCvtColor(*canny_1, *canny_3, #CV_GRAY2BGR, 1)
          *select.IplImage = cvCreateImage(selection\width, selection\height, #IPL_DEPTH_8U, 3)
          cvSetImageROI(*canny_3, selection\x, selection\y, selection\width, selection\height)
          ...
          cvAdd(*image, *canny_3, *image, #Null)
          cvResetImageROI(*image)
          cvResetImageROI(*canny_3)
  ...
  FreeMemory(*param)
  cvReleaseImage(@*canny_3)
  cvReleaseImage(@*canny_1)
  cvReleaseImage(@*gray)
  cvDestroyAllWindows()

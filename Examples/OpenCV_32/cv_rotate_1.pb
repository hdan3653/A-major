...
#CV_DESCRIPTION = "Calculates an affine matrix of 2D rotation, applying the transformation to an image." +
                  Chr(10) + Chr(10) + "- TRACKBAR: Adjust the angle."
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200
      ...
      *matrix.CvMat = cvCreateMat(2, 3, CV_MAKETYPE(#CV_32F, 1))
      ...
      *param\uValue = window_handle
      ...
      Repeat
        If *resize
          cv2DRotationMatrix(*resize\width / 2, *resize\height / 2, nDegree, 1, *matrix)
          cvWarpAffine(*resize, *rotate, *matrix, #CV_INTER_LINEAR + #CV_WARP_FILL_OUTLIERS, 0, 0, 0, 0)

...
; 좌표값 옮겨주는 함수
Procedure ChangePos_lv3(*this.myPosition)
...
Procedure showCurrentBar()
  ...
  ;Debug "코드번호" + Str(bar_list(currentBar)\chord()\num)
  
  InitMySprite_lv3("Bar" + Str(chordCount), "graphics/graphics_lv3/"+Str(bar_list(currentBar)\chord()\num) + ".png", x, 10, 0, 1)
  ;*p\filename = "graphics/graphics_lv3/" + Str(bar_list(currentBar)\chord()\num)
...
Procedure AddNote()
  ...
  If x > 1440
    ...
    Else
      ...
      *p\active = 1
      ...
      InitMySprite_lv3("note"+Str(inputTone+1), "graphics/graphics_lv3/lines"+Str(inputTone+1)+".png", x, y, 1, 1)
      bar_list(currentBar)\note()\num = inputTone+1
  ...
  Else
    ...
    If x<>800
      ...
      ;Debug PreviousElement(bar_list(currentBar)\note())

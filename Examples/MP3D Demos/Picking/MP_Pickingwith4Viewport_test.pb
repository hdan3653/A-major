...
tex0 = MP_CreateTextureColor(256, 256, RGBA(255, 125, 125, 125))
...
MP_EntitySetTexture(Mesh2, tex0)
MP_EntitySetTexture(Mesh3, tex0)
MP_EntitySetTexture(Mesh4, tex0)
  ...
  If MP_MouseButtonDown(0) ; Linke Maustaste gedrückt?
      If GetFocus_()=WindowID(0) ; Fenster aktiv? 
         ...
         If Meshfound
            ...
            MP_EntitySetTexture(Meshfound, tex1)
            MP_RenderEnd() 

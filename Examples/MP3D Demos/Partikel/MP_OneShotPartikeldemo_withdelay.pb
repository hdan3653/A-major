...
;// File Title: MP_OneShotPartikeldemo_withdelay.pb
;// Created On: 3.8.2012
;// Updated On: 
;// Author: Michael Paulwitz
;// OS:Windows
;// 
;// Demofile for Oneshot partikelemmiter with delay
;// 
;////////////////////////////////////////////////////////////////
...
While Not MP_KeyDown(#PB_Key_Escape) And Not WindowEvent() = #PB_Event_CloseWindow; Esc abfrage oder schliessen
    ...
    If MP_MouseButtonHit(0)
      ...
      Particle = MP_CreateOneShotEmitter (3, pointPosit\x,pointPosit\y,0,20, 20,1, 6, 6)
      
      Particle2 = MP_CreateOneShotEmitter (4, pointPosit\x,pointPosit\y,0,20, 20,1, 0, 6)
      MP_ParticleEmitterStartTime(Particle2, 0.5)
      
       Particle3 = MP_CreateOneShotEmitter (8, pointPosit\x,pointPosit\y,0,20, 20,1, 0, 6)
      MP_ParticleEmitterStartTime(Particle3, 2)

...
SetWindowTitle(0, "Wobble Effect Shader") 
...
;{ Postprossesing
    ...
    If Dir = 0 
      Wobb_x.f + 0.01 : Wobb_y.f + 0.01
      If Wobb_x.f => 10.0 : Dir = 1 : EndIf
    EndIf
    
    If Dir = 1 
      Wobb_x.f - 0.01 : Wobb_y.f - 0.01
      If Wobb_x.f =< -10.0 : Dir = 0 : EndIf
    EndIf
    
    
    MP_ShaderSetVar_f (MyShader,"Wobb_x",Wobb_x)
    MP_ShaderSetVar_f (MyShader,"Wobb_y",Wobb_y)

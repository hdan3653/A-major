...
;// Dateiname: MP_Stairs.pb
;// Erstellt am: 16.11.2011
;// Update am  : 
;// Author: Michael Paulwitz
;// 
;// Info: 
;// 2D Physic box on stairs
;// 2D Physik Box auf Treppe
;//
;//
;////////////////////////////////////////////////////////////////
...
;- ***  Create Window
MP_Graphics3DWindow(0, 0, wX, wY, "Chipmunk4PB Demo: Stair, Space makes more Objects", #PB_Window_ScreenCentered | #PB_Window_SystemMenu)
...
; Aussenrand
MP_2DPhysicStaticLine(2, 2, 2, wY-2 ,1)
MP_2DPhysicStaticLine(2, wY-2, wX-2, wY-2,1)
MP_2DPhysicStaticLine(wX-2, 2, wX-2, wY-2,1)

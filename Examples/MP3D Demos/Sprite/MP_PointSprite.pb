...
;// 
;// Info: 
;// How to create you own Point Sprites
;// Wie man selber eigene PointSprites erzeugt
;//
;//
;////////////////////////////////////////////////////////////////
...
SetWindowTitle(0, "MP3D Point Sprite") ; Setzt einen Fensternamen
...
identity\m[14] = 3 ;z position der matrix

...
;     position1 = FindString(*p\sprite_name, "bubble")
...
Procedure StaticAnt(bar.i, state.i)
  b.i
  b = bar
  code = userAnswers(b)
  ...
  note2X = Lv2_antX+105
  note2Y = Lv2_noteY+60  
  note0.i: note1.i: note2.i
  
  Select code
    Case #CODE_C
      note0 = 1:      note1 = 3:      note2 = 5
    Case #CODE_G
      note0 = 5:      note1 = 7:      note2 = 2
    Case #CODE_F
      note0 = 4:      note1 = 6:      note2 = 1
    Case #CODE_Am
      note0 = 6:      note1 = 1:      note2 = 3
    Case #CODE_Dm
      note0 = 2:      note1 = 4:      note2 = 6
    Case #CODE_Em
      note0 = 3:      note1 = 5:      note2 = 7
  EndSelect
  
  InitMySprite("note"+Str(currentBar)+"\0", "../graphics/bubble"+Str(note0)+".png", note0X, note0Y)
  InitMySprite("note"+Str(currentBar)+"\1", "../graphics/bubble"+Str(note1)+".png", note1X, note1Y)
  InitMySprite("note"+Str(currentBar)+"\2", "../graphics/bubble"+Str(note2)+".png", note2X, note2Y)
...
If *capture
  ...
  *image.IplImage : pbImage = CreateImage(#PB_Any, 640, 480)
  ...
  ForEach sprite_list()
    PrintN(sprite_list()\sprite_name + " - " + sprite_list()\active)
  Next
  PrintN("----------------")

...
// Get/SetGadgetAttribute
//
#define PB_OpenGL_MouseX       2
#define PB_OpenGL_MouseY       3
#define PB_OpenGL_Buttons      4
#define PB_OpenGL_Key          5
#define PB_OpenGL_Modifiers    6
#define PB_OpenGL_Cursor       7
#define PB_OpenGL_WheelDelta   8
#define PB_OpenGL_Input        9
#define PB_OpenGL_Clip         10
#define PB_OpenGL_CustomCursor 11
#define PB_OpenGL_SwapBuffer   12
#define PB_OpenGL_SetContext   13

// for PB_OpenGL_Modifiers
//
#define PB_OpenGL_Shift        (1 << 0)
#define PB_OpenGL_Alt          (1 << 1)
#define PB_OpenGL_Control      (1 << 2)
#define PB_OpenGL_Command      (1 << 3)

// for PB_OpenGL_Buttons
//
#define PB_OpenGL_LeftButton    (1 << 0)
#define PB_OpenGL_RightButton   (1 << 1)
#define PB_OpenGL_MiddleButton  (1 << 2)

...
#elif defined(LINUX) && !defined(PB_MACOS)
...
void PB_Event_AddWithFlags(int EventID, integer ObjectID, integer WindowID, integer EventType, void *Data, EventDataFreeFunction FreeData, int Flags);
int  PB_Event_Get();
int  PB_Event_PeekID();
int  PB_Event_Peek(integer *ObjectID, integer *WindowID, integer *Type);
void PB_Event_Lock();
void PB_Event_Unlock();
void PB_Event_ClearAll(integer WindowID);
void PB_Event_UnbindAll(integer WindowID);
void PB_Event_Clear(int ID, integer ObjectID, integer WindowID, integer Type);

...
#define PURELIBRARY_H
  ...
  #ifdef X86
	  #define M_PBFUNCTION(type) type _stdcall
		#define M_PBVIRTUAL _stdcall
		#define M_SYSFUNCTION(type) type _stdcall
    #define M_SYSVIRTUAL _stdcall
		#define M_CALLBACK int _stdcall
	#else // X64 doesn't have several calling convetion
	  #define M_PBFUNCTION(type) type
		#define M_PBVIRTUAL
		#define M_SYSFUNCTION(type) type
    #define M_SYSVIRTUAL
		#define M_CALLBACK int
	#endif
 // removed the extern
  ...
  #define MAX_PATH PATH_MAX
    ...
    #ifdef X86
      #define M_SYSFUNCTION(a) a __attribute__((stdcall))
  ...
  wchar_t *pb_wcscat(wchar_t *s1, const wchar_t *s2);
  wchar_t *pb_wcschr(const wchar_t *s, wchar_t c);
  int      pb_wcscmp(const wchar_t *s1, const wchar_t *s2);
  wchar_t *pb_wcscpy(wchar_t *s1, const wchar_t *s2);
  size_t   pb_wcslen(const wchar_t *s);
  int      pb_wcsicmp(const wchar_t *s1, const wchar_t *s2);
  int      pb_wcsncmp(const wchar_t *s1, const wchar_t *s2, size_t n);
  int      pb_wcsnicmp(const wchar_t *s1, const wchar_t *s2, size_t n);
  wchar_t *pb_wcsncpy(wchar_t *s1, const wchar_t *s2, size_t n);
  wchar_t *pb_wcsdup(const wchar_t *s);
  wchar_t *pb_wcsstr(const wchar_t *big, const wchar_t *little);
  wchar_t *pb_wmemchr(const wchar_t *s, wchar_t c, size_t n);
  void     pb_itow(int val, wchar_t *dst, int radix);
  int      pb_wtoi(const wchar_t *String);
  int      pb_swprintf(wchar_t *Buffer, const wchar_t *Format, ...);
